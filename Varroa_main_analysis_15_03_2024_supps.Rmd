...
mod_dos2 <- MCMCglmm(logratio ~ Dosage_level,
                                 rcov=~units,
                                 random =~StudyID ,
                                 family ="gaussian",
                                 data = Full_dosage,
...
mod_dos3 <- MCMCglmm(logratio ~ Dosage_level,
                                 rcov=~units,
                                 random =~StudyID ,
                                 family ="gaussian",
                                 data = Full_dosage,
...
mod_spec_chem2 <- MCMCglmm(logratio ~ broadTreatment,
                                 rcov=~units,
                                 random =~StudyID 
                                          + Continent 
                                          + Cont_Country,
...
mod_spec_chem3 <- MCMCglmm(logratio ~ broadTreatment,
                                 rcov=~units,
                                 random =~StudyID 
                                          + Continent 
                                          + Cont_Country,
...
mod_Full_bio2 <- MCMCglmm(logratio ~ SubCategory1Treatment,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_Full_bio3 <- MCMCglmm(logratio ~ SubCategory1Treatment,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_bees_life <- MCMCglmm(logratio ~ life_treat,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_bees_life2 <- MCMCglmm(logratio ~ life_treat,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_bees_life3 <- MCMCglmm(logratio ~ life_treat,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_HoneyBeeIncrease2 <- MCMCglmm(logratio ~ chem_split,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_HoneyBeeIncrease3 <- MCMCglmm(logratio ~ chem_split,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_HoneyBeeReduction2 <- MCMCglmm(logratio ~ chem_split,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_HoneyBeeReduction3 <- MCMCglmm(logratio ~ chem_split,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_VarroaReduction <- MCMCglmm(logratio ~ chem_split,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_VarroaReduction2 <- MCMCglmm(logratio ~ chem_split,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_VarroaReduction3 <- MCMCglmm(logratio ~ chem_split,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_VarroaIncrease <- MCMCglmm(logratio ~ chem_split,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_VarroaIncrease2 <- MCMCglmm(logratio ~ chem_split,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_VarroaIncrease3 <- MCMCglmm(logratio ~ chem_split,
                                 rcov=~units,
                                 random =~StudyID_control 
                                          + Continent 
                                          + Cont_Country,
...
mod_spec_chem_HI2 <- MCMCglmm(logratio ~ broadTreatment,
                                 rcov=~units,
                                 random =~StudyID 
                                          + Continent 
                                          + Cont_Country,
...
mod_spec_chem_HI3 <- MCMCglmm(logratio ~ broadTreatment,
                                 rcov=~units,
                                 random =~StudyID 
                                          + Continent 
                                          + Cont_Country,
...
mod_spec_chem_Vb2 <- MCMCglmm(logratio ~ broadTreatment,
                                 rcov=~units,
                                 random =~StudyID 
                                          + Continent 
                                          + Cont_Country,
...
mod_spec_chem_Vb3 <- MCMCglmm(logratio ~ broadTreatment,
                                 rcov=~units,
                                 random =~StudyID 
                                          + Continent 
                                          + Cont_Country,
